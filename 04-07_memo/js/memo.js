    ...
    save.addEventListener("click",
        function (e) {
            ...
            if (key == "" || value == "") {
                ...
                viewStorage();
                let w_msg = "localStorage に" + key + " " + value + "を保存(ほそん)しました。"
                window.alert(w_msg);
...
function allClearLocalStorage() {
    ...
    allClear.addEventListener("click",
        function (e) {
            e.preventDefault();
            let w_confirm = confirm("LocalStorageのデータすべて削除(all clear)します。\nよろしいですか?");
            if (w_confirm == true) {
                localStorage.clear();
                viewStorage();
...
function viewStorage() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
        ...
        let td1 = document.createElement("td"); // td ... table data
